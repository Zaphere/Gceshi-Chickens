      ...
      <div className="container px-4 mx-auto">
        ...
        <div className="grid md:grid-cols-2 gap-12 max-w-5xl mx-auto">
          ...
          >
            ...
            <div className="absolute inset-0 bg-gradient-to-t from-black/90 via-black/30 to-transparent p-8 flex flex-col justify-end md:translate-y-4 md:group-hover:translate-y-0 transition-transform duration-500">
              <h3 className="text-3xl font-serif font-bold text-white mb-2">Cleaned Broilers</h3>
              <p className="text-gray-200 mb-6 opacity-100 md:opacity-90 md:group-hover:opacity-100 transition-opacity">Fully processed, cleaned, and ready for your pot. Perfect for immediate cooking.</p>
              <div className="flex items-center justify-between">
                <span className="text-primary font-bold text-2xl">E90.00</span>
                <Button
                  variant="secondary"
                  className="hover:bg-primary hover:text-secondary transition-colors font-semibold"
          ...
          >
            ...
            <div className="absolute inset-0 bg-gradient-to-t from-black/90 via-black/30 to-transparent p-8 flex flex-col justify-end md:translate-y-4 md:group-hover:translate-y-0 transition-transform duration-500">
              ...
              <p className="text-gray-200 mb-6 opacity-100 md:opacity-90 md:group-hover:opacity-100 transition-opacity">Strong, healthy 6-week old broilers. Ideal for bulk buyers and fresh meat preference.</p>
              <div className="flex items-center justify-between">
                <span className="text-primary font-bold text-2xl">E90.00</span>
                <Button
                  variant="secondary"
        ...
        >
          ...
          <Button
            size="lg"
            className="bg-secondary hover:bg-secondary/90 text-white px-10 py-6 text-lg rounded-full shadow-lg hover:shadow-xl hover:-translate-y-1 transition-all"
