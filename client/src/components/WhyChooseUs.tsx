  ...
  return (
    <section className="py-24 bg-muted/30">
      <div className="container px-4 mx-auto">
        ...
        >
          <h2 className="text-3xl md:text-5xl font-serif font-bold text-secondary mb-4">Why Choose Gceshi Chickens?</h2>
          <motion.div 
            initial={{ width: 0 }}
        ...
        >
          {features.map((feature, index) => (
            <motion.div key={index} variants={item}>
              <Card className="border-none shadow-lg hover:shadow-2xl transition-all duration-300 hover:-translate-y-2 h-full bg-white/50 backdrop-blur-sm border-t-2 border-transparent hover:border-primary">
                <CardContent className="p-8 flex flex-col items-center text-center">
                  <div className="p-4 rounded-full bg-primary/10 text-primary mb-6 group-hover:bg-primary group-hover:text-secondary transition-colors duration-300">
